...
class TestStreamlitRender:
    ...
    def test_app_loads(self):
        """Verify the app initializes cleanly without runtime exceptions."""
    ...
    def test_headers_present(self):
        """Ensure main header and subtitle render correctly."""
        app = AppTest.from_file("src/app.py")
        app.run()
    ...
    def test_sidebar_instructions(self):
        """Verify the sidebar includes diagnostic workflow instructions."""
        app = AppTest.from_file("src/app.py")
        app.run()
        markdown_texts = [m.value for m in app.markdown]
